...
javac -d target/classes --module-path $PATH_TO_FX --add-modules javafx.controls src/main/java/com/innatecoder/java_field/javafx/LabelClass.java
java -cp target/classes --module-path $PATH_TO_FX --add-modules javafx.controls com.innatecoder.java_field.javafx.LabelClass
*/ 


package com.innatecoder.java_field.javafx;
